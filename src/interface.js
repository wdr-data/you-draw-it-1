  ...
  */
  ...
  function completeDOM() {
    ...
    options.questions.forEach(function(q) {
      ...
      question.append("h2") 
      .append("div")  
      .attr("class", "textAboveHeading update-font")
      .html(q.textAboveHeading);
      question.append("p") 
      .append("div")  
      ...
      question.append("div")
        ...
        .attr("data-key", q.key);
      question.append("p")
        .attr("class", "dataSource update-font")
        .html(q.dataSource);
      ...
      question.append("p") 
        .append("div")  
        .attr("class", "textBelow update-font") 
        .html(q.textBelow);
      ...
      question.append("p")
        .append("div")
        .attr("class", "textBelow3 update-font")
        .html(q.textBelow3);
    });
  }
